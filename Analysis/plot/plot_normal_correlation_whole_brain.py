...
for label in cfg.analyses.keys():
    ...
    file = 'analysis_normalR_' + label + '_Rs_relative__thresholded_corrected.nii'
...
for label in cfg.analyses.keys():
    ...
    filename ='analysis_normalR_' + label + '_Rs_relative_thresholded_uncorrected.nii'
    ...
    if label == 'shot':
        ...
        for cut, MNI_coords in enumerate(MNI_coords_all):
            ...
            display.add_overlay(dir_data + 'analysis_normalR_' + label + '_Rs_relative__thresholded_corrected.nii',
        ...
        display.add_overlay(dir_data + 'analysis_normalR_' + label + '_Rs_relative__thresholded_corrected.nii',  colorbar=True, alpha=1, cmap='autumn', vmin=vmin, vmax=vmax)
        for ROI in cfg.ROIs:
            display.add_contours(cfg.dir_ROI + ROI + '.nii', colors='k', levels=[3.0], linewidths=1, alpha = 1.0)
