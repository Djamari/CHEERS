...
for cope = [3,6]
    for n = subjects
        ...
        matlabbatch{1}.spm.spatial.coreg.estwrite.ref = {['/huge/soyorh/studyforrest-data-aligned/', subjectName,'/in_bold3Tp2/', subjectName,'_task-avmovie_run-1_bold.nii,1']};
        matlabbatch{1}.spm.spatial.coreg.estwrite.source = {['/home/djaoet/wrkgrp/Djamari/StudyForrest/data raw/anat/', subjectName,'/anat/', subjectName,'_T1w.nii,1']};
        ...
        matlabbatch{2}.spm.spatial.preproc.tissue(1).tpm = {'/home/djaoet/Toolboxes/spm12/tpm/TPM.nii,1'};
        ...
        matlabbatch{2}.spm.spatial.preproc.tissue(2).tpm = {'/home/djaoet/Toolboxes/spm12/tpm/TPM.nii,2'};
        ...
        matlabbatch{2}.spm.spatial.preproc.tissue(3).tpm = {'/home/djaoet/Toolboxes/spm12/tpm/TPM.nii,3'};
        matlabbatch{2}.spm.spatial.preproc.tissue(3).ngaus = 2;
        matlabbatch{2}.spm.spatial.preproc.tissue(3).native = [1 0];
        matlabbatch{2}.spm.spatial.preproc.tissue(3).warped = [0 0];
        matlabbatch{2}.spm.spatial.preproc.tissue(4).tpm = {'/home/djaoet/Toolboxes/spm12/tpm/TPM.nii,4'};
        matlabbatch{2}.spm.spatial.preproc.tissue(4).ngaus = 3;
        matlabbatch{2}.spm.spatial.preproc.tissue(4).native = [1 0];
        matlabbatch{2}.spm.spatial.preproc.tissue(4).warped = [0 0];
        matlabbatch{2}.spm.spatial.preproc.tissue(5).tpm = {'/home/djaoet/Toolboxes/spm12/tpm/TPM.nii,5'};
        matlabbatch{2}.spm.spatial.preproc.tissue(5).ngaus = 4;
        matlabbatch{2}.spm.spatial.preproc.tissue(5).native = [1 0];
        matlabbatch{2}.spm.spatial.preproc.tissue(5).warped = [0 0];
        matlabbatch{2}.spm.spatial.preproc.tissue(6).tpm = {'/home/djaoet/Toolboxes/spm12/tpm/TPM.nii,6'};
        ...
        matlabbatch{3}.spm.spatial.normalise.write.subj.resample = {['/home/djaoet/wrkgrp/Djamari/StudyForrest/data raw/functional localizer/', subjectName,'/2ndlvl.gfeat/cope', num2str(cope), '.feat/stats/cope1.nii,1']};
